...
**Features**
* Secure login and registration system for user accounts
* An intuitive dashboard displaying key financial metrics
* Easily add, edit, and delete income and expense records
